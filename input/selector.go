...
// ----------------------------------------------------------------------------
func Read(ctx context.Context, inputURL, engineConfigJson string, engineLogLevel, numberOfWorkers, visibilityPeriodInSeconds int, logLevel string, jsonOutput bool) bool {
	// if len(logLevel) > 0 {
