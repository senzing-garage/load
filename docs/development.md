...
1. Run program.
   ...
   1. macOS
      ...
      ```console
      ${GIT_REPOSITORY_DIR}/target/darwin-amd64/load
...
1. Senzing documentation will be in the "Third party" section.
   `github.com` > `senzing-garage` > `load`
...
1. Determine if `load` is installed.
   Example:

   ```console
   apt list --installed | grep load

   ```

1. :pencil2: Install `load`.
   Example:

   ```console
   cd ${GIT_REPOSITORY_DIR}/target
   sudo apt install ./load-0.0.0.deb
...
1. Remove `load` from system.
   Example:

   ```console
   sudo apt-get remove load
...
[Go Reference]: https://pkg.go.dev/github.com/senzing-garage/load
[go]: https://github.com/senzing-garage/knowledge-base/blob/main/WHATIS/go.md
[How to Install Senzing for Go Development]: https://github.com/senzing-garage/knowledge-base/blob/main/HOWTO/install-senzing-for-go-development.md
[localhost:6060]: http://localhost:6060/pkg/github.com/senzing-garage/load/
