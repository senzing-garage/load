...
More information at https://github.com/senzing/load
...
More information can be found in the [pkg/github.com/senzing/load/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/senzing/load/anotherpackage"
	)
