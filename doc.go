...
More information at https://github.com/senzing-garage/load
...
More information can be found in the [pkg/github.com/senzing-garage/load/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/senzing-garage/load/examplepackage"
		"github.com/senzing-garage/load/anotherpackage"
	)
